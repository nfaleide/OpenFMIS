...
@router.get("/", response_model=dict | None, summary="Get config")
...
@router.put("/", response_model=dict, summary="Update config")
...
@router.post("/test", response_model=dict, summary="Test email")
